...
for i, r in enumerate(results):
    print(f"{i+6}. {r['name']}: {r['result']} | {r['status']} | {r['time_ms']}ms")

with open("api_test_results_2.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=2)
print(f"\nResults saved to api_test_results_2.json")
